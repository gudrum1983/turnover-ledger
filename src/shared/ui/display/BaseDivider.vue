...
<template>
  <div
    class="BaseDivider"
    :class="[
      `BaseDivider_style_${lineStyle}`,
      `BaseDivider_labelPosition_${labelPosition}`,
      { BaseDivider_isVertical: isVertical, BaseDivider_hasLabel: isLabelVisible },
    ]"
    :style="styleVars"
    role="separator"
    :aria-orientation="isVertical ? 'vertical' : 'horizontal'"
  >
    <span v-if="isLabelVisible" class="BaseDivider_Label">{{ label }}</span>
  </div>
</template>
